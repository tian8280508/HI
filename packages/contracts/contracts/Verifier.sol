...
contract PlonkVerifier {
    ...
    uint256 constant Qmx = 9500438448273539853450343759780147945738482107361465947048596292056845130956;
    uint256 constant Qmy = 15927137187192307838016663175279055080376486884799552106284516264653918426258;
    uint256 constant Qlx = 246904744868758095149227074049563373583310616766206529965590716022631915945;
    uint256 constant Qly = 17276186597062626641515555510571530413934264646947765789140436701085408384099;
    uint256 constant Qrx = 13852764046736767822605214724707732494936607275360278843207065627736398322762;
    uint256 constant Qry = 12536775981653019902432983202921565433122539732846381697593793676986939901345;
    uint256 constant Qox = 11707631606221840378762986750935240406386409004316124598973882378153926779132;
    uint256 constant Qoy = 16812537672511929030760479502650845358644147094567451790139540463295219825261;
    uint256 constant Qcx = 6207001605302430328332897927999629446741736397960785150246002109378794272491;
    uint256 constant Qcy = 18677938145449399984287389558420839002208611168575264400599697981820385374607;
    uint256 constant S1x = 3962647989349659753994321191680596948218018617680794277503828115192503195470;
    uint256 constant S1y = 18185598184921702830195654256974805511743316372122102768985242993229896506566;
    uint256 constant S2x = 21761119402061251849455007261639645892905956061009250189590143738078333137211;
    uint256 constant S2y = 3126399604759508255099301925589568772532799182449880091980162915034464277426;
    uint256 constant S3x = 17070924882401095171505583085397406524336325966675492903501530169188194149208;
    uint256 constant S3y = 10818450300907206535795717390212272825035056004775578607352585671542095604909;
    uint256 constant k1 = 2;
    uint256 constant k2 = 3;
    uint256 constant X2x1 = 8988237548328325690211810690863416983669621463507956215176009454103304758763;
    uint256 constant X2x2 = 10923873759092747850593301887544892422341324462084252663061046090142645409763;
    uint256 constant X2y1 = 9059548191693840666185873421633829333058549635187317977229104528947488976521;
    uint256 constant X2y2 = 11420931118910519470628719466612359967280842753876441263169135317300343346903;
